...
@section('content')
    <div class="banner">
        ...
        <div class="w3l_banner_nav_right">
            ...
            <div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_veg" style="margin-top: 20px">
                                    ...
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{ asset('storage/images/'. $product->image) }}" alt=" " class="img-responsive" /></a>
                                                <p>{{ $product->product_name }} ({{ $product->quantity }}{{ $product->unit }})</p>
                                                <h4>Rs.{{ $product->price }} <span></span></h4>
                                            </div>
                                            <div class="snipcart-details">
                                                <!--<form action="#" method="post">
                                                    ...
                                                    <div id="Add{{ $product->id }}">
                                                    <input type="" id="btn{{$product->id}}" onclick="qty('{{$product->id}}','{{$product->price}}','{{$product->product_name}}','{{ $product->quantity }}','{{$product->unit}}')" value="Add to cart" class="button" />
                                                  <input type="text" class="form-control" id="quantity{{$product->id}}" value="1">
                                                    </div>
                                                    <div class="dec" id="inc{{ $product->id }}">
                                                        <input type="button" id="increment{{ $product->id }}" onclick="decrementValue('{{ $product->id }}')" value="-" />
                                                        <input type="text" name="quantity" value="0" maxlength="2" max="10" size="1" id="number{{$product->id}}" />
                                                        <input type="button" id="decrement{{ $product->id }}" onclick="incrementValue('{{ $product->id }}')" value="+" />
                                                    </div>
                                            </div>
                                        </div>
                                    </figure>
